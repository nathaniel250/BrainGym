...
<body>
	...
	<div class="cover-container">
    		...
    		<div class="inner cover">
          			<img src = "<c:url value="/resources/img/Brain-Gym1.png"/>" alt ="">
            		<p class="lead" style="color:#005b7f;">Exercise your brain.</p>
            
            		<p class="lead">
            			<form action="searchQuiz">
            		...
            		<p class="lead">
            			<form action="addQuiz">
            				<button class="btn btn-lg btn-success">Create A Quiz!</button>	
            			</form>
            		</p>
			</div>
